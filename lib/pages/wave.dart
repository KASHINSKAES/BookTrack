...
import 'package:booktrack/pages/config.dart';
...
class WaveWidget extends StatefulWidget {
  ...
  WaveWidget({
    ...
    this.isLoop = true, required List<Color> colors, required List<int> durations, required List<double> heightPercentages,
  });
