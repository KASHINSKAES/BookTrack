...
import 'package:booktrack/pages/ProfilePages/Chat/roomsPages.dart';
import 'package:booktrack/pages/LoginPAGES/AuthProvider.dart';
import 'package:booktrack/pages/LoginPAGES/AuthWrap.dart';
import 'package:booktrack/pages/ProfilePages/Payment/PaymentMethodsPage.dart';
import 'package:booktrack/pages/ProfilePages/Treker/activityPages.dart';
import 'package:booktrack/pages/ProfilePages/Bonus/bonusPages.dart';
import 'package:booktrack/pages/ProfilePages/languagePages.dart';
import 'package:booktrack/pages/ProfilePages/Level/levelPage.dart';
import 'package:booktrack/pages/ProfilePages/Quote/loveQuote.dart';
import 'package:booktrack/pages/ProfilePages/Statistic/statistikPages.dart';
      ...
      child: Column(
        children: [
          ...
          TextButton(
              ...
              child: Text(
                'Выйти',
                style: TextStyle(fontSize: 24 * scale, color: AppColors.orange),
              )),
        ],
      ),
    );
